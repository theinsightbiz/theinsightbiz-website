...
export default function About() {
  ...
  return (
    <section
      className="page wide"
      style={{ marginTop: "0.5rem", position: "relative", zIndex: 0 }}
    >
      {/* Intro */}
      <div className="pr-hero">
        <span className="ribbon" aria-hidden="true"></span>
        <h1 style={{ fontWeight: 900, letterSpacing: "-0.5px" }}>
          About INSIGHT
        </h1>
        <p style={{ maxWidth: 860 }}>
          We are a seasoned business consultant specializing in financial
          advisory, tax compliance and business setup solutions across India,
          UAE, UK and USA. With deep expertise in regulatory frameworks and
          financial strategies, we help businesses optimise operations, save
      ...
      >
        ...
        >
          ...
          <p>
            We bring a personalized, results-driven approach to every client
            engagement. Whether you're expanding internationally, optimizing
            taxes, or seeking financial clarity, we ensure tailored solutions to
            meet your business goals.
          </p>
          <p>
            Let's Connect!
            <br />
            Reach out to us today and discuss how we can help streamline your
            business operations and ensure compliance in dynamic markets.
          </p>
          ...
          <div className="tile-grid" style={{ marginTop: ".4rem" }}>
            <article className="tile">
              ...
              <p className="m0">
                India, UAE, UK, USA - Global Coverage. Consistent Delivery.
              </p>
            </article>
            <article className="tile">
              <h3>Precision You Can Present</h3>
              <p className="m0">
                Investor-ready documents and clean papers your board can act on.
              </p>
            </article>
            <article className="tile">
              <h3>From First Call to Final Filing</h3>
              <p className="m0">
                We plan, paper, file, and maintain so you always stay current.
              </p>
            </article>
          </div>
        </section>
        ...
        <section id="services" className="panel-premium">
          ...
          <p>
            We combine advisory, documentation and filing into proven service
            lines—each with clear scope, timelines and deliverables.
          </p>
        ...
        <section id="team" className="panel-premium">
          ...
          <p>
            Certified professionals backed by internal review, checklists, and
          ...
          <div className="tm-grid">
            ...
            <article className="member-card">
              ...
              <div className="member-card__info" aria-hidden="true">
                ...
                <p className="member-card__bio">
                  Cross border consultant assisting founders operate seamlessly
                  and Specializes in India, UAE, UK, USA tax and compliances. He
                  designs tax-efficient structures, manages filings, and turns
                  complex tax rules into simple checklists.
                </p>
              ...
              <button
                className="member-card__sr-toggle"
                aria-label="Toggle details for touch devices"
              ></button>
            </article>
            ...
            <article className="member-card">
              ...
              <div className="member-card__info" aria-hidden="true">
                ...
                <p className="member-card__bio">
                  Expertise with guiding the founders upon incorporations across
                  India, UAE, UK & USA, backed by India SEBI regulations, FEMA
                  regulations for foreign investments/remittances, and Companies
                  Act, 2013 secretarial compliances.
                </p>
                <div className="member-card__socials">
                  <a
                    className="icon-btn"
            ...
            <article className="member-card">
              ...
              <div className="member-card__info" aria-hidden="true">
                ...
                <p className="member-card__bio">
                  Specialist in Income-tax compliance and assessments. Builds
                  bank-ready project finance models and term-sheet
                  documentation. Handles Startup Registrations/ NGO setup and
                  its periodic accounting and filings.
                </p>
                <div className="member-card__socials">
                  <a
                    className="icon-btn"
            ...
            <article className="member-card">
              ...
              <div className="member-card__info" aria-hidden="true">
                ...
                <p className="member-card__bio">
                  Partners with founders to run a clean monthly MIS, owning
                  books close, variance analysis, and decision-ready reports.
                  Managing India GST compliance, audit support, and UAE VAT
                  filings, with robust ledger-to-return reconciliations.
                </p>
                <div className="member-card__socials">
                  <a
                    className="icon-btn"
